 ...
 *
 * In the stacked (vertical) layout the copy travels up from below for the first
 * ~40% of a scene, so the interfaces wait and play their whole arc inside the
 * hold. Side-by-side layouts have no such conflict and use the raw value.
 */
export const stagedTime = (t, stacked) => (stacked ? (t - 0.34) / 0.62 : t);
