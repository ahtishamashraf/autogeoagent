          ...
          <div className="border-t border-white/8">
            {faqs.map((faq) => (
              <details key={faq.question} className="group border-b border-white/8">
                {/*
                  The layout lives on a child of <summary>, never on <summary>
                  itself: overriding a summary's `display` stops the browser
                  hiding the disclosure content, which paints every answer on
                  top of the question below it.
                */}
